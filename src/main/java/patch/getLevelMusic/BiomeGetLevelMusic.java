...
@ModMethodPatch(target = Biome.class, name = "getLevelMusic", arguments = {Level.class, PlayerMob.class})
public class BiomeGetLevelMusic {
    @Advice.OnMethodExit()
    static void onExit(@Advice.This Biome biome, @Advice.Argument(0) Level level, @Advice.Argument(1) PlayerMob perspective, @Advice.Return(readOnly = false) List<GameMusic> music) {
