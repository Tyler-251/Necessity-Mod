...
import level.maps.biomes.PirateVillageBiome;
...
public class PirateVillageBiomeGetLevelMusic {
    @Advice.OnMethodExit()
    static void onExit(@Advice.This PirateVillageBiome biome, @Advice.Argument(0) Level level, @Advice.Argument(1) PlayerMob perspective, @Advice.Return(readOnly = false) List<GameMusic> music) {
