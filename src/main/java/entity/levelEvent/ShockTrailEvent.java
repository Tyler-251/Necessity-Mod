...
public class ShockTrailEvent extends MobAbilityLevelEvent implements Attacker {
    ...
    public ShockTrailEvent() {
    }

    public ShockTrailEvent(Mob owner, GameDamage damage, int startX, int startY, int targetX, int targetY, int seed) {
    ...
    public void init() {
        ...
        this.trail = new LightningTrail(new TrailVector((float)this.startX, (float)this.startY, this.xDir, this.yDir, 5.0F, 14.0F), this.level, new Color(246, 228, 197, 255));
